...
#Sort items by their loadings on the first factor (you can choose any factor)
...
cor_melted <- melt(as.matrix(cor_matrix))
...
ggplot(cor_melted, aes(Var1, Var2, fill = value)) +
    ...
    theme_minimal() +
    labs(x = "", y = "", title = "Heatmap of Sorted Correlations") +
...
ggplot(data.frame(Factor = 1:n_factors, CumulativeVariance = cum_var_explained), aes(x = Factor, y = CumulativeVariance)) +
    ...
    labs(x = "Factor", y = "Cumulative Variance Explained")
