...
Cleaning the data involved the handling of missing values. 15% of the data was missing and there were no complete rows. In order to address this missingness, imptuation was used with the makeX() function from the glmnet() package.
