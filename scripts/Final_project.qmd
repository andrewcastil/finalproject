...
m1 <- corrplot(corr= matrix1, method = "square", title = "Correlation Matrix for Anxiety")

#Correlation matrix for factor 2
matrix2 <-cor(imp_sim[,26:50], use="pairwise") 
head(unlist(matrix)[,1:5], 10)

m2<- corrplot(corr= matrix2, method = "square", title = "Correlation Matrix for Hopelessness")

#Correlation matrix for factor 3
matrix3 <-cor(imp_sim[,51:75], use="pairwise") 
head(unlist(matrix)[,1:5], 10)

m3 <- corrplot(corr= matrix3, method = "square", title = "Correlation Matrix for Resentment")

#Correlation matrix for factor 4
matrix4 <-cor(imp_sim[,76:100], use="pairwise") 
head(unlist(matrix)[,1:5], 10)

m4<- corrplot(corr= matrix4, method = "square", title = "Correlation Matrix for Shame")
