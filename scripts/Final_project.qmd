...
These findings align with prior research (Castillo & Condon, 2023) which show imaginative emotional valence is strongly associated with pathological personality traits, suggesting a clinically significant (Zimmermann et al., 2019; Miller et al., 2022) link between imagination and affective psychopathology. This is particularly the case for the emergent factors of Shame and Hopelessness, which are defined by emotionally saturated items (e.g. "I see no hope for the future" or "I feel ashamed when I picture myself in comparison to others").

Similarly, the Anxiety factor is similar to the Frequency dimension of the FFIS, revolving around persistent intrusive thoughts which impede adaptive behaviors and can result in perceptual dysregulation. The observed patterns in this study mirrored the patterns observed in Castillo & Condon (2023). These associations point to the potential of excessive engagement in imagination in contributing to thought disorders (Andrews-Hanna & Grilli, 2021), indicating imaginative frequency is of clinical significance. These findings reinforce the clinical relevance of imaginative frequency and anxiety induced by imagination. 
Of the four emergent factors, resentment demonstrated the weakest psychometric properties, which may be attributable to the factor's association with antisocial traits like the Dark Triad. Aggression and imagination are known to correlate with opposing constructs (imagination with openness, aggression with limited openness) and this may be resulting in attenuation effects. The Dark Triad literature (see Kay & Arrow, 2022) suggests a link with Machiavellianism, relating to adopting a socially predatory strategy. Our findings do support this, suggesting resentment may play into plotting revenge and attempting to set verbal "traps" for others.
