...
#I'd put a bar chart to show this because of this
...
#A bar chart would look good here!
...
First, sample demographics and visualizations are provided below. As can be seen, the simulated sample is quite diverse in terms of number of countries , ages, and races represented, which is good for scale development.
...
We found four factors of imagination emerge from our analyses. The items clustered around four points, the four main factors: anxiety, hopelessness, resentment, and shame, suggesting that the items administered are measuring one of four types of maladaptive imagination. This is visualized below.
...
Lastly, we add a proportion of variance explained plot to show how well the factors account for the variance in the response data. From this figure, we can see that each factor explains additional and about equal variance.
