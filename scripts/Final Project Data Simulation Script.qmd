...
```{r}
#handling NAs by replacing with the mean
imp_scale <- makeX(scale_data, na.impute = TRUE, sparse = FALSE)
imp_sim <- makeX(simulated_data, na.impute = TRUE, sparse = FALSE)

#Kayla can so some more here with pivot functions
```
